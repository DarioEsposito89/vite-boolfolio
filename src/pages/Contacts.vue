    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <h2 class="my-3">Leave me your contact details and write a message. I will contact you as soon as possible</h2>

                <form @submit.prevent="onClickSubmit" v-if="!success">
                    <div class="mb-3">
                        <label for="name" class="form-label">name e lastname</label>
                    ...
                    <button type="submit" class="btn btn-primary more-button mt-4">Send</button>
                </form>
